...
## 意欲・興味
## 上流工程から参画して開発をリードできるエンジニアになりたい。
業務や個人開発を通して一通りwebサービスを0から作成できる力が付いたと思います。次のステップとして要件定義や設計から参画してプロジェクトをリードしていける力をつけていきたいと考えています。

## 世の中に価値を提供できていて、利益を上げているサービスの開発に携わりたい。
ユーザーからのフィードバックを受けながらアジャイル形式で開発していく事を好みます。ユーザーに価値を提供し、その対価として利益が生まれるという仕組み作りに参画したいと考えています。

## Golangを使用した実務経験を得たい
シンプル・コード補完が充実・処理速度が速い等々、Golangに触れてみて習得したいという興味が湧いております。
